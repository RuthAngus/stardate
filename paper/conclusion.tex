...
precision of the equivalent evolutionary point (EEP) parameter and, since EEP,
...
photometry for dust-extinction {\it before} analysis can improve the accuracy
of stellar ages measured with \sd.
