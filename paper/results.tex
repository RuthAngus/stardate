...
This suggests that latitudinal spot drifting does not affect significantly
...
around 5\%.
However it is likely that this effect is will become more important at older
ages.
...
This star is relatively metal poor: $\mathrm{[Fe/H]} = -0.13 \pm$ 0.09 dex,
and that could be the cause of its anomalously rapid rotation.
}
