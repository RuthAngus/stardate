...
color.
For example, most \kepler\ stars have 2MASS photometry in J, H and K bands and
\Gaia\ photometry in $G$, $G_{BP}$ and $G_{RP}$, but do not all have B and V
band colors.
...
equation \ref{eqn:iso_likelihood}.
