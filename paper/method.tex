...
colors (spanning spectral types A0 through M6), of any open cluster.
...
\racomment{The above part of this section describes the mean and variance
relations we used to model the rotation periods of stars as a function of
their ages (and colors, EEPs, masses and metallicities).
In what follows, we describe how we combined this model with a stellar
