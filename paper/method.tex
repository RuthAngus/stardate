...
\end{equation}
\begin{equation}
    \log_{10}(P_{rot}) = 0.65\log_{10}A -4.72 + 0.72C -4.92C^2 + 28.71C^3 -38.96C^4
\end{equation}
where C is $\log_{10}(G_{BP}-G_{RP})$ and $A$ is age in years, for stars with
\gcolor\ $<$ 2.7 and
\begin{equation}
    P_{\mathrm{rot}} = f(A)h(C) \nonumber,
\end{equation}
\begin{equation}
    \log_{10}(P_{rot}) = 0.65\log_{10}(A) + 0.94 -13.56C,
\end{equation}
