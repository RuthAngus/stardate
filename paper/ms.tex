...
% keep it simple!
% Calibrate a new functional form that swaps the outdated B-V for Gaia Bp-Rp.
% Switch to a pure isochrone fitting approach for hot stars and evolved stars
% for now.
% In the next paper do the calibration, add a mixture model, use logg, mass
% and Fe/H.
% Add a turnover at the Rossby equivalent (function of mass and rotation
% period)
